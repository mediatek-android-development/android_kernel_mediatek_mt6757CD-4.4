...
static int nl80211_set_power_save(struct sk_buff *skb, struct genl_info *info)
{
	...
	if (ps_state != NL80211_PS_DISABLED && ps_state != NL80211_PS_ENABLED && ps_state != NL80211_PS_MAXINUM)
		return -EINVAL;
	...
	state = (ps_state != NL80211_PS_DISABLED) ? true : false;

	if (ps_state == NL80211_PS_MAXINUM) {
		ps_timeout = 1;  //Any value that is not equal -1 will be ok
	} else {
