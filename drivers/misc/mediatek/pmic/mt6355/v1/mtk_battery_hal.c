...
void battery_dump_nag(void)
{
	...
	bm_err("[read_nafg_vbat4] %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
		pmic_get_register_value(PMIC_AUXADC_SPL_NUM),
		pmic_get_register_value(PMIC_AUXADC_SPL_NUM_LARGE),
		pmic_get_register_value(PMIC_AUXADC_SPL_NUM_SLEEP),
		pmic_get_register_value(PMIC_AUXADC_SPL_NUM_SLEEP_SEL),
		pmic_get_register_value(PMIC_AUXADC_SPL_NUM_SEL_WAKEUP),
		pmic_get_register_value(PMIC_AUXADC_SPL_NUM_SEL_BAT_TEMP),
		pmic_get_register_value(PMIC_AUXADC_SPL_NUM_SEL_LBAT),
		pmic_get_register_value(PMIC_AUXADC_SPL_NUM_SEL_SHARE),
		pmic_get_register_value(PMIC_AUXADC_SPL_NUM_SEL),
		pmic_get_register_value(PMIC_AUXADC_SPL_NUM_CH0),
		pmic_get_register_value(PMIC_AUXADC_SPL_NUM_CH3),
		pmic_get_register_value(PMIC_AUXADC_SPL_NUM_CH7),
		pmic_get_register_value(PMIC_AD_AUXADC_COMP),
		pmic_get_register_value(PMIC_AUXADC_DA_DAC_SWCTRL),
		pmic_get_register_value(PMIC_AUXADC_DA_DAC)
	);
}
...
static signed int read_hw_ocv(void *data)
{
	...
	*(signed int *) (data) = 37000;
	...
	ret = fg_is_charger_exist(&is_charger_exist);
	if (is_charger_exist == 0)
		g_fg_is_charger_exist = false;
	else
		g_fg_is_charger_exist = true;
