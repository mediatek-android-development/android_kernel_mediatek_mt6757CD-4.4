...
/* [liliwen] Add rt5081_db_lcm_drv_chip */
struct rt5081_pmu_chip *rt5081_db_lcm_drv_chip;
...
/* [liliwen start] Add rt5081_db_reg_update_bits_lcm_drv */
int rt5081_db_reg_update_bits_lcm_drv(u8 addr, u8 mask, u8 data)
{
	return rt5081_pmu_reg_update_bits(rt5081_db_lcm_drv_chip, addr, mask, data);
}
/* [liliwen end] */
...
static int rt5081_pmu_dsv_probe(struct platform_device *pdev)
{
	...
	/* [liliwen] rt5081_db_lcm_drv_chip */
	rt5081_db_lcm_drv_chip = dsv_data->chip;
