...
*/
#define DEGREE_TO_RAD				7506//57
/* [yanlin start] Optimize calibration (1/3) */
// 912, Typ Sensitivity for Rfs2000 is 16.4
#define DEGREE_TO_RAD_OLD			164
// Magnification is 131 for HAL
#define CORRECTION_FACTOR			1310
/* [yanlin end] */
