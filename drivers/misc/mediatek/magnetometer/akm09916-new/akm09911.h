...
#define AKM09911_I2C_ADDRESS 	0x0C
#define AKM09911_BUFSIZE		0x50

#ifdef AKM_Device_AK09916
#define SENSOR_DATA_SIZE		9	// [yanlin] Changed back from 10 to 9
#else
...
#ifdef AKM_Device_AK09916
#define AKM_SENSOR_DATA_SIZE	9	// [yanlin] Changed back from 10 to 9
#else
