...
static struct device_attribute tcpc_device_attributes[] = {
	...
	TCPC_DEVICE_ATTR(cc_polarity, S_IRUGO), /* [fengyunliang] Add typec_polarity info */
};
...
enum {
	...
	TCPC_DESC_TIMER,
	TCPC_DESC_CAP_INFO,
	TCPC_DESC_CC_POLARITY, /* [fengyunliang] Add typec_polarity info */
};
				  ...
				  struct device_attribute *attr, char *buf)
{
	...
	case TCPC_DESC_ROLE_DEF:
		...
		break;
	/* [fengyunliang start] Add typec_polarity info */
