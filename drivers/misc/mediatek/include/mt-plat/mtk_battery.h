...
#define BM_DAEMON_DEFAULT_LOG_LEVEL 7	// [lidebiao] Open GM3.0 log for debug
...
extern bool is_set_transport_mode(void);	// [lidebiao] Added to enter shipping_mode
...
extern int get_Batt_Temp_Protect_Mode(void);	// [lidebiao] Add for config batt temp protect
/* [lidebiao start] Disable charging for Runin test */
extern int get_Charging_Mode(void);
extern bool get_Runin_Test_Mode(void);
/* [lidebiao end] */
...
#define CALL_ACTIVE_ICHR 600000
extern unsigned int get_Call_State(void);
/* [lidebiao end] */
