...
/* [liguanxiong] change 0 -> 1, enable id detect */
...
#define __SUNWAVE_SCREEN_LOCK_EN      1   // fingerprint cannot unlock, when screen is off
#define __SUNWAVE_HW_INFO_EN          1   // enable SUNWAVE_SET_VERSION_INFO in ioctl
/* [liguanxiong]  fingerprint fast light up */
#define SUNWAVE_FAST_LIGHTUP          0   //If support fast lightup screen mechanism.
