...
u32 rsee_do_call_with_arg(struct tee_context *ctx, phys_addr_t parg)
{
	...
	while (true) {
		...
		/*[jiangtingyu start] Add rongcard log dump*/
		} else if (res.a0 == RSEE_SMC_RETURN_COREDUMP) {
			/*
			 * Out of threads in secure world, wait for a thread
			 * become available.
			 */
			printk("rsee_tee_core_dump start\n");
			rsee_tee_core_dump();
			printk("rsee_tee_core_dump end\n");
			param.a0 = RSEE_SMC_RETURN_RPC_COREDUMP;
		/*[jiangtingyu end]*/
